...
| --- | --- | --- | --- |
| bigbluebutton-server | 9002 | Web-GUI database management tool | Y |
| phpmyadmin | 9090 | Web-GUI database management tool | Y |
## Documentation

[BigBlueButton Administrator Guide](https://support.websoft9.com/docs/bigbluebutton)

## Enterprise Support

If you want to get our Enterprise Support to ensure high availability of applications, you can subscribe our [BigBlueButton Enterprise Support](https://apps.websoft9.com/bigbluebutton) 
